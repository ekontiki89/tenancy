...
class CreateTenant extends Command
{
    ...
    protected $description = 'Crea un inquilino con el nombre proporcionado y la dirección de correo electrónico, php artisan tenant:create company email@examle.com';
    ...
    public function handle()
    {
        ...
        //CreateHostname::dispatch($name ,$email);
